...
class _UserManagementPageState extends ConsumerState<UserManagementPage>
  ...
  void _handleUserAction(String action, UserModel user) {
    switch (action) {
      ...
      case 'edit':
        ...
        break;
      case 'rfid':
        _showRfidManagementDialog(user);
        break;
      case 'activate':
      case 'deactivate':
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow(
                'RFID Card',
                user.rfidCardId ?? 'Belum di-assign',
              ),
  ...
  void _showRfidManagementDialog(UserModel user) {
    showDialog(
      context: context,
      builder: (context) => _RfidManagementDialog(user: user),
    );
  }
...
/// Dialog untuk manajemen RFID card
class _RfidManagementDialog extends StatefulWidget {
  final UserModel user;

  const _RfidManagementDialog({required this.user});

  @override
  _RfidManagementDialogState createState() => _RfidManagementDialogState();
}

class _RfidManagementDialogState extends State<_RfidManagementDialog> {
            ...
            if (_nfcAvailable)
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: Text(_isScanning ? 'Scanning...' : 'Scan Kartu RFID'),
                  style: ElevatedButton.styleFrom(
